    ...
    <div class="modalss">
      <div class="modal-set">
        ...
        <div class="content-bottom">
          <div style="font-size:13px">
            ...
            <div style="display:inline-block;margin-left:6px;font-weight: 400;">
              我已阅读并同意
              <span style="color:rgb(24, 195, 170)">「多抓鱼协议」</span>
            </div>
          </div>
        </div>
        <div class="wechat" v-bind:class="tiks===false ? 'colors' : ''">
          ...
          <a
            id="font-set"
            href="https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxc3758a49f9d0e965&redirect_uri=http://192.168.6.226:8080/Authorize&response_type=code&scope=snsapi_userinfo#wechat_redirect"
          >微信登录或注册</a>
        ...
        <div class="wechat" v-bind:class="tiks === false ? 'colors' : ''">
          ...
          <a
            id="font-set"
            href="https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxc3758a49f9d0e965&redirect_uri=http://192.168.6.28:8080/Authorize&response_type=code&scope=snsapi_userinfo#wechat_redirect"
          >微信登录或注册</a>
        </div>
