        ...
        <div class="wholelist-mook">
            <div v-for="(whbook,index) in wholebook " :key="index">
                <div class="wholelist-alignTop" style="flex-wrap: wrap;" >
                        <div class="wholelist-collection" :style="{'background':'linear-gradient(to top, rgba(35, 67, 135, 0.3) 35%, '+whbook.bgColor+' 69%) center top / auto no-repeat, url(https://images.weserv.nl/?url='+whbook.image+') center center / cover no-repeat'}" >
                            <div class=""  @click="goBookCollection(whbook.id)" style="display: block; box-sizing: border-box; width: 100%; height: 100%; padding: 16px; position: relative;" >
                                <span class="wholelist-inner">
                                    ...
                                    <div class="Flex" style="position: absolute; bottom: 16px; right: 16px; flex-flow: row-reverse;" >
                                        
                                        <span class="wholelist-avatar" v-for="(user,index) in whbook.users" :key="index">
